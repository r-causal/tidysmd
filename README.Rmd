...
**Note: tidysmd has been subsumed under the [halfmoon package](https://r-causal.github.io/halfmoon/); all the functions in this pacakge are re-exported in halfmoon. While tidysmd will remain on CRAN, we recommend using the halfmoon package instead**
